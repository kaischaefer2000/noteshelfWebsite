            ...
            >
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-md sm:max-w-xl sm:mx-auto md:mt-5 md:text-md lg:mx-0">
                  Kennst du dieses Problem, wenn du eine Notiz suchst und
                  einfach nicht mehr weist wo du sie in dein Buch geschreiben
                  hast? Also ich schon- und ich hasse es! Deshalb habe ich den
                  Thought Collector entwickelt. Eine{" "}
